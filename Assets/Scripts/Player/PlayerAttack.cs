...
public class PlayerAttack : MonoBehaviour
{
    ...
    [SerializeField] private LayerMask enemyMask;        // ��Ʈ�ڽ��� ����ũ
    ...
    [SerializeField] private float active = 0.06f;   // ���� Ȱ��
    [SerializeField] private float recovery = 0.12f; // �ĵ�
    [SerializeField] private float minRecovery = 0.05f;  // �ּ� �ĵ� ����
